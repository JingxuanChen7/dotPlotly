...
if (opt$similarity) {
  gp = ggplot(alignments) +
    geom_rect(aes(xmin=686567, xmax=686642, ymin=0, ymax=Inf, fill="0")) +
    geom_rect(aes(xmin=686745, xmax=689495, ymin=0, ymax=Inf, fill="1")) +
    geom_rect(aes(xmin=689597, xmax=689669, ymin=0, ymax=Inf, fill="2")) +
    scale_fill_manual(values = c("0"="#e6f598","1"="#ef8a62","2"="#999999"), labels = c("0"="s79+_TY1", "1"="t80-_TY1","2"="tRNA-GlnTTG"), name ="Legend" ) +
    geom_point(
